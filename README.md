...
| Path | Per-frame time |
|---|---|
| x264 veryfast | 7.35 ms |
| Apple M3 hardware encode | 3.35 ms |
| Streaming rewrite | 3.70 ms |
...
|---|---|---|---|
| Before | 1920x1080 | encode only | 2438 kbps |
| After | 1280x720 → 1920x1080 | Streaming + 1.5× MagicSR | 1526 kbps |
